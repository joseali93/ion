...
export declare abstract class DynamicFormControlContainerComponent implements OnChanges, OnDestroy {
    ...
    protected constructor(componentFactoryResolver: ComponentFactoryResolver, layoutService: DynamicFormLayoutService, validationService: DynamicFormValidationService);
    ngOnChanges(changes: SimpleChanges): void;
    ngOnDestroy(): void;
    readonly abstract componentType: Type<DynamicFormControl> | null;
