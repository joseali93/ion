...
var DynamicFormValueControlModel = /** @class */ (function (_super) {
    ...
    function DynamicFormValueControlModel(config, layout) {
        ...
        _this.additional = typeof config.additional === "object" && config.additional !== null ? config.additional : null;
        _this.hint = config.hint || null;
        _this.required = typeof config.required === "boolean" ? config.required : false;
