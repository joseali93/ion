...
export const /** @type {?} */ DYNAMIC_FORM_CONTROL_TYPE_TEXTAREA = "TEXTAREA";
export const /** @type {?} */ DYNAMIC_FORM_TEXTAREA_WRAP_HARD = "hard";
export const /** @type {?} */ DYNAMIC_FORM_TEXTAREA_WRAP_SOFT = "soft";
/**
 * @record
 */
